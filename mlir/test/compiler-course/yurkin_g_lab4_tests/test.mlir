...
// --pass-pipeline="builtin.module(example_MLIR)" %s | FileCheck %s CHECK:
// func.call @trace_condition_then_begin() CHECK: func.call
// @trace_condition_then_end() CHECK: func.call @trace_condition_else_begin()
